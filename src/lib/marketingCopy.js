...
export const t = {
  en: {
    ...
    wantFullDesc: "This is a sample. The full output covers every unit across every active Bratislava new-build project, refreshed every day.",
    // Pricing
    ...
    // Tiers
    tiers: [
      { tier: "Snapshot", name: "One-time report", price: "€249", note: "One-time snapshot, single delivery",
      ...
      { tier: "Standard", name: "Full access", price: "€349", priceSuffix: "/mo", note: "Billed monthly, cancel anytime",
        features: [[true, "Live dashboard + full market report"], [true, "Raw + cleaned datasets included"], [true, "Historical snapshots & trend analysis"], [true, "Absorption rates & sell-out tracking"], [true, "Google Sheets, CSV, or API access"]], featured: true, cta: "Get Started" },
      { tier: "Custom", name: "On-Demand & Enterprise", price: "Let's talk.", isCustom: true, note: "Tailored scope, frequency, and delivery",
        features: [[true, "Everything in Standard"], [true, "Custom refresh cadence & priority support"], [true, "Coverage beyond Bratislava"], [true, "Additional markets or property types"], [true, "Custom integrations and output formats"]], cta: "Contact Us" },
    ],
  ...
  sk: {
    ...
    tiers: [
      { tier: "Snapshot trhu", name: "Jednorazový prehľad", price: "€249", note: "Jednorazový snapshot, jedno doručenie",
      ...
      { tier: "Standard", name: "Plný prístup", price: "€349", priceSuffix: "/mes", note: "Fakturované mesačne, zrušenie kedykoľvek",
        features: [[true, "Live dashboard + kompletný report"], [true, "Surové + vyčistené datasety"], [true, "Historické dáta a vývoj trendov"], [true, "Absorpcia a sledovanie vypredania"], [true, "Google Sheets, CSV alebo API"]], featured: true, cta: "Mám záujem" },
