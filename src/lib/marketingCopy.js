...
export const t = {
  en: {
    ...
    deliveryItems: [
      ...
      ["Historical trends", "Every price change we have recorded, unit by unit — the same flat followed through time, which is the comparison that still holds when the mix of what is on sale shifts."],
    ],
  ...
  sk: {
    ...
    deliveryItems: [
      ...
      ["Cenové trendy", "Každá zmena ceny, ktorú sme zaznamenali — byt po byte, ten istý byt v čase. To je porovnanie, ktoré platí aj vtedy, keď sa mení zloženie toho, čo je na trhu."],
    ],
