...
export const t = {
  en: {
    ...
    tiers: [
      ...
      { tier: "Standard", name: "Full access", price: "€25", priceSuffix: "/mo", note: "Billed monthly, cancel anytime",
  ...
  sk: {
    ...
    tiers: [
      ...
      { tier: "Standard", name: "Plný prístup", price: "€25", priceSuffix: "/mes", note: "Fakturované mesačne, zrušenie kedykoľvek",
