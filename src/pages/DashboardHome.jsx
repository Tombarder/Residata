...
const METRICS = {
  ...
  avg_m2:      { label: { sk: "Priem. cena/m²", en: "Avg price/m²" }, hint: { sk: "predajná, s DPH",            en: "sale price, incl. VAT"  }, fmt: "m2", info: { sk: "Priemerná cena za m² (s DPH) bytov v predaji, vážená počtom bytov. Ráta sa len z bytov, ktoré majú zverejnenú cenu aj plochu. Byty bez ceny (veľká časť ponuky) do priemeru nevstupujú, takže priemer pokrýva menej bytov než počty vedľa neho.", en: "Average price per m² (incl. VAT) of units for sale, weighted by unit count. Computed only from units with a published price and area. Units without a price — a large share of the offer — are not in the average, so it covers fewer units than the counts beside it." } },
  sold30:      { label: { sk: "Predané jednotky/30 dní", en: "Units sold/30 days" }, hint: { sk: "tempo predaja",         en: "sales pace"             }, fmt: "count", accent: orange, requires: "view_sold_velocity", info: { sk: "Koľko bytov sa predalo za posledných 30 dní.", en: "How many units sold in the last 30 days." } },
